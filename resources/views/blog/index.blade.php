        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <a href="{{route('blog.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add</a>
                    </div>
