            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active" aria-current="page">Blog Categories Edit</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="mt-4" method="post" action="{{route('categories.update', $cat->id)}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control {{ $errors->first('name') ? 'is-invalid' : '' }}" value="{{$cat->name ?: old('name')}}" required>
