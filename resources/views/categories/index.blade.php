                        ...
                        <table id="zero_config" class="table table-borderless v-middle no-wrap" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="font-14 font-weight-medium text-muted">Categories name</th>
