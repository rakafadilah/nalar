            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="index.html">Frontpage</a>
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Frontpage list</h4>
                    <div class="mb-3">
                        <a href="{{route('pages.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add</a>
                    </div>
